    ...
    <>
      <div className="container">
        ...
        <p>
          ...
          <i>collectively</i>
          ‘Pondr’, ‘we’ or ‘us’) collects, uses, and discloses information about
          you. This Privacy Policy applies when you use our website, mobile
          application, and services that link to this Privacy Policy
        ...
        <p>
          ...
          with us via third-party platforms, request customer support, or
          otherwise communicate with us. The types of personal information we
          may collect include your name, username, bio, email address, business
          information, your content, including your profile photo, photos,
        ...
        <ul>
          ...
          <li>
            ...
            Services are popular, and count visits. We also work with third
            party analytics providers who use cookies, web beacons, device
            identifiers, and other technologies to collect information about
            your use of our Services and other websites and applications,
            including your IP address, web browser, mobile network information,
            pages viewed, time spent on pages or in mobile apps, and links
            clicked. This information may be used by Pondr to, among other
            things, analyze and track data, determine the popularity of certain
            content, deliver content targeted to your interests on our Services,
        ...
        <p>
          ...
          ). When you interact with an Embed, it can send information about your
          interaction to the hosting third party just as if you were visiting
          the third party’s site directly. For example, when you load a Pondr
          post page with a YouTube video Embed and watch the video, YouTube
          receives information about your activity, such as your IP address and
          how much of the video you watch. Pondr does not control what
          information third parties collect through Embeds or what they do with
          the information. This Privacy Policy does not apply to information
          collected through Embeds. The privacy policy belonging to the third
          party hosting the Embed applies to any information the Embed collects,
          and we recommend you review that policy before interacting with the
          Embed. We are not responsible for the practices of such third parties,
        ...
        <p>
          ...
          of Pondr. For example, we use data we have to investigate suspicious
        ...
        <p>
          ...
          to take steps to keep your personal information safe, such as choosing
          a strong password and keeping it private, as well as logging out of
        ...
        <ol>
          ...
          <li>
            ...
            your profile information through your profile settings. Once you
            disconnect a Linked Network, we will not receive information from
            that Linked Network going forward unless you choose to reconnect it.
            You may also control whether the Linked Network is visible in your
        ...
        <p>
          ...
          information from a child under the relevant age without parental
          consent, we take steps to delete that information. If you’re a parent
          or guardian and you are aware that your child has provided us with
          personal information, please contact us so that we can accordingly
        ...
        <p>
          ...
          details about the precise data points, we collect and the categories
          of sources of such collection, please see the Collection of
        ...
        <p>
          ...
          you have provided such an agent with a power of attorney or that the
          agent otherwise has valid written authority to submit requests to
          exercise rights on your behalf. This may include requiring you to
          verify your identity. If you are an authorized agent seeking to make a
        ...
        <p>
          ...
          ), the United Kingdom, or Switzerland, you have certain rights and
          protections under applicable law regarding the processing of your
        ...
        <p>
          ...
          physiological and mental health condition; (iv) sexual orientation;
          (v) medical records and history; (vi) biometric information; (vii) any
          details relating to the above clauses as required for providing you
          with access to the Platform; and (viii) any of the information
          received under above clauses for processing, stored or processed under
          lawful contract or otherwise. Unless otherwise specified in the
          Privacy Policy, ‘personal information’ will include ‘sensitive
          personal information’ as well. By way of illustration, you will have
          provided us such consent by your conduct if you choose to share your
          personal information while using the Pondr, such as by including
        ...
        <p>
          ...
          long as necessary to carry out the purposes for which we originally
          collected it and for other legitimate business purposes, including to
          meet our legal, regulatory, or other compliance obligations.
        </p>
        <br />
